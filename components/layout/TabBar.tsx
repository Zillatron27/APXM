    ...
    <nav className="flex bg-apxm-bg border-t border-apxm-surface">
      {tabs.map((tab) => (
        <button
          ...
          className={`flex-1 min-h-touch flex items-center justify-center relative font-mono text-[11px] font-semibold tracking-wider uppercase border-l border-apxm-surface first:border-l-0 ${
